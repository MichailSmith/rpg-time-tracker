...
func InitDatabase() (err error) {
	...
	DB.Create(&model.User{ID: "111382688166855739752", Username: "Gabe", Password: "tyrislord", Email: "gabesmith100@gmail.com", IsGm: true})
	...
	DB.Create(&model.Time{ID: "6", UserID: "111382688166855739752", CampaignName: "Descent into Avernus", ElapsedTime: 0})
